...
namespace PropertyLeasing.API.Services
{
    public class LeaseLifecycleService : ILeaseLifecycleService
    {
        ...
        {
            [ApplicationStatuses.Submitted] = new HashSet<string> { ApplicationStatuses.Screening },
        ...
        {
            return string.IsNullOrWhiteSpace(status) ? ApplicationStatuses.Submitted : status.Trim();
        }
    }
}
